'use client'
import { NoticeBoardData, Notice } from "@/notice-board-data"
...
const Items = ({ data }: {data: Notice}) => {
  return (
    <div>
      <div className={`${data.status}  relative px-2 py-1 rounded-md overflow-hidden font-medium ${data.status === 'standard' ? 'text-[#4c4c4c]' : 'text-white'}`}>
