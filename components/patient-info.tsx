    ...
    <div className="flex flex-col w-full relative">
      <div className="bg-[#FBFBFB] outline outline-[#DCDCDC] outline-1 rounded-t-lg p-2 flex justify-between items-center">
        <div className="flex gap-1">
          <Image src="./icons/patient-card.svg" width={20} height={20} alt="profile" />
          <p className="md:text-lg text-sm font-medium">Hasta Bilgileri</p>
        </div>
        <div className="flex gap-1">
      ...
      <div className="outline-[#DCDCDC] max-h-96 overflow-y-auto rounded-b-lg gap-5 outline-1 outline bg-white flex flex-col p-3 relative">
