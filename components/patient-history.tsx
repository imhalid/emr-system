                ...
                <div className="flex md:flex-row flex-col gap-10 justify-between  px-3 py-2 outline outline-1 outline-[#F8F8F7]  rounded-b-lg">
                  <div className="flex-col gap-3 flex min-w-48">
                    <div>
                      ...
                      <p className="text-sm text-[#222126]">{item.details.appointment_date}</p>
                    </div>
                    <div>
                      <p className="text-xs text-[#8C8C8C] uppercase font-medium">Muayene Türü</p>
                      <p className="text-sm text-[#222126]">{item.details.examination_type}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#222126]">{item.details.result}</p>
                    </div>
                  </div>
